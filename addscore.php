...
?>
<p>
Points for Surviving Members <?php echo $scores[0]; ?><br>
...
$finalscore = $scoreSum * $_SESSION["playParty"]->_job;
?>

Score : <?php echo $scoreSum; ?><br><br>
Because you played as a <?php echo  $_SESSION["playParty"]->_jobVal[$_SESSION["playParty"]->_job][0];?> 
you have<br> earned <?php echo $_SESSION["playParty"]->_job; ?> times your score.<br><br>
